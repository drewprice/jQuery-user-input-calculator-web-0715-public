  ...
  describe('validating inputs', function() {
    ...
    describe('validates operators', function() {
      ...
      it('should validate that a +, -, /, or * was used', function() {
        $('#number1').val(3);
        $('#operator').val('marshmallow');
        $('#number2').val(5);
        $('#equals').click();

        expect($('#result').text()).toBe('Sorry, not a valid operator!');
      });
